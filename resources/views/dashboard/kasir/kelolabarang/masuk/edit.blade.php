    ...
    <div class="row">
        <div class="col-sm-5 offset-sm-3">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('kasir.kelola-barang.masuk.edit.aksi', $barangMasuk->id) }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="kode_barang">Kode Barang</label>
                            <input type="text" class="form-control" disabled value="{{ $barangMasuk->kode_barang }}" readonly>
                        </div>
                        <div class="form-group">
